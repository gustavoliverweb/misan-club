...
import { ArrowRight, Clock, Sun, Target, ArrowRight as ArrowRightIcon } from "lucide-react";
import { MarketingNav } from "@/components/marketing/nav";
import { MarketingFooter } from "@/components/marketing/footer";

const contenidos = [
  "Activar tu propósito de vida con claridad y convicción",
  "Instalar rutinas conscientes que generen resultados",
  "Equilibrar todas las áreas de tu vida con la Rueda de la Vida",
  "Aprender a decir NO para proteger tu energía y enfoque",
  "Construir la base sólida de tu nueva vida en 45 días",
];

export default function DelSofaParte1Page() {
  return (
      ...
      <div className="pt-14">
        ...
        <div className="mx-auto max-w-5xl px-6 py-5">
          <nav className="flex items-center gap-2 text-xs text-muted flex-wrap">
            ...
            <span>/</span>
            <span className="text-fg">Del sofá al éxito · Parte 1</span>
          </nav>
        </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.04] px-3 py-1.5">
              ...
              <span className="text-[11px] font-medium uppercase tracking-[0.12em] text-muted">
                45 días · Renace en 90 días — Parte 1
              </span>
            </div>
            ...
            >
              Del sofá al éxito
              <br />
              <span className="text-muted">Parte 1</span>
            </h1>

            <p className="mt-4 text-sm font-medium text-accent" style={{ letterSpacing: "-0.01em" }}>
              Renace en 90 días: construye la base de tu nueva vida.
            </p>

            <p className="mt-4 max-w-lg text-base leading-relaxed text-muted">
              Primera mitad del sistema de transformación de 90 días. 45 días de
              trabajo diario para activar tu propósito, instalar rutinas y
              equilibrar todas las áreas de tu vida.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-5">
              ...
              >
                ...
                <div className="space-y-5">
                  {[
                    ...
                    { Icon: Target, label: "Recomendado", value: "Por la mañana" },
                    { Icon: ArrowRightIcon, label: "Siguiente paso", value: "Del sofá al éxito — P2" },
                ...
                <div className="mt-7 border-t border-white/[0.06] pt-6">
                  ...
                  <div className="h-1.5 overflow-hidden rounded-full bg-white/5">
                    <div
                      ...
                      style={{ width: "50%", background: "rgba(0,153,255,0.6)" }}
                    />
                  </div>
                  <p className="mt-2 text-[10px] text-muted">45 de 90 días</p>
                </div>
              </div>
              ...
              >
                ...
                <div className="mt-6 flex items-center justify-between rounded-xl border border-white/[0.06] bg-subtle px-5 py-4">
                  <div>
                    <p className="text-xs text-muted">Continúa con</p>
                    <p className="mt-0.5 text-sm font-medium text-fg">Del sofá al éxito — Parte 2</p>
                  </div>
                  <Link
