...
const contenidos = [
  ...
  "Mentalidad de abundancia aplicada al día a día",
  "Estrategias reales para generar ingresos adicionales",
];

export default function MentesRicasPage() {
  return (
      ...
      <div className="pt-14">
        ...
        <div className="mx-auto max-w-5xl px-6 py-5">
          <nav className="flex items-center gap-2 text-xs text-muted flex-wrap">
            ...
            <span>/</span>
            <span className="text-fg">Mentes Ricas, Ingresos Reales</span>
          </nav>
        </div>
        ...
        <section className="relative px-6 pb-16 pt-8">
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <p className="mt-6 max-w-lg text-base leading-relaxed text-muted">
              Un taller quincenal para activar tu mentalidad y tus ingresos.
              Sesiones prácticas donde eliminas bloqueos y aprendes a vender
              productos reales con resultados inmediatos.
            </p>
          </div>
        </section>
              ...
              >
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-muted">
                    Para personas que quieren generar ingresos reales mientras
                    transforman la mentalidad que los ha limitado hasta ahora.
                    Mentalidad abierta y compromiso de aplicar lo aprendido.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-5xl">
            ...
            >
              ...
              <p className="mx-auto mt-4 max-w-xs text-sm leading-relaxed text-muted">
                Activa tu membresía y accede a este taller junto a todos los
